...
<main data-tag-page="true" class="flex-grow py-20 bg-cover bg-pos-strips" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/backpages/stripes.png);">
    ...
    <div class="w-11/12 lg:w-10/12 mx-auto my-16" id="upcoming-events">
        <div class="title flex mb-6 flex-col lg:flex-row">
            ...
            <div class="category-filter w-56 lg:w-60 xl:w-52 flex items-center lg:ml-20 my-5 lg:my-0 filter-category" data-container=".upcoming-post-wrapper" data-event="upcoming" data-tag="<?php echo $tag->term_id; ?>">
    ...
    <div class="w-11/12 lg:w-10/12 mx-auto my-16" id="past-events">
        <div class="title flex mb-6 flex-col lg:flex-row">
            ...
            <div class="category-filter w-56 lg:w-60 xl:w-52 flex items-center lg:ml-20 my-5 lg:my-0 filter-category" data-container=".past-post-wrapper" data-event="past" data-tag="<?php echo $tag->term_id; ?>">
                <div class="font-medium relative">
                    <div class="filter-header cursor-pointer flex flex-row border-swissred border py-1 px-2 h-8">
                        <div class="flex self-center flex-col">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/backpages/icon-catagories-2x.png" class="w-5 mr-2" />
    ...
    <?php if ($tag->slug == 'washington-dc' && 1 == 2) : ?>
        <!--div class="pt-12 text-center">
            <a href="/category/economic-relations/" class="btn">Experience Swiss Impact</a>
        </div-->
    <?php endif; ?>
</main>
<?php get_footer(); ?>