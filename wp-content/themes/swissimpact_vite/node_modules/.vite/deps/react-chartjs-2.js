...
function j(n) {
  ...
  } }), D(y(P, { context: e.context }, n.__v), e.l)) : e.l && e.componentWillUnmount();
}
function z(n, e) {
  var r = y(j, { __v: n, i: e });
...
function ChartComponent(props, ref) {
  ...
  const canvasRef = _2(null);
  const chartRef = _2(null);
  const renderChart = () => {
  ...
  return Cn.createElement("canvas", {
    ref: canvasRef,
    role: "img",
    height,
    width,
...
var Chart2 = k2(ChartComponent);
function createTypedChart(type, registerables) {
  Chart.register(registerables);
  return k2((props, ref) => Cn.createElement(Chart2, {
    ...props,
    ref,
    type
  }));
