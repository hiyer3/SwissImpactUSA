...
<main class="flex-grow pt-20 bg-cover bg-pos-strips" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/backpages/stripes.png);">
    <div class="slider-wrapper w-11/12 mx-auto lg:ml-auto lg:mr-0" id="highlights">
        ...
        <?php
        $featured_posts = get_field('event_page_highlights', 'option');
        ?>
    ...
    <div class="w-11/12 lg:w-10/12 mx-auto my-16" id="upcoming-events">
        <div class="title flex mb-6 flex-col lg:flex-row">
            ...
            <div class="category-filter w-56 lg:w-60 xl:w-52 flex items-center lg:ml-20 my-5 lg:my-0 filter-category" data-container=".upcoming-post-wrapper" data-event="upcoming">
                <div class="font-medium relative">
                    <div class="filter-header cursor-pointer flex flex-row border-swissred border py-1 px-2 h-8">
                        <div class="flex self-center flex-col">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/backpages/icon-catagories-2x.png" class="w-5 mr-2" />
                        </div>
                        ...
                        ?>
                                <div class="left-0 p-1 w-full border-b">
                                    <div class="flex items-center">
                                        <input type="checkbox" class="mr-1" id="filter-<?php echo $category->slug; ?>" name="<?php echo $category->term_id; ?>">
                                        <label for="filter-<?php echo $category->slug; ?>">
                                            <figure>
                                                <img src="<?php echo $custom_query_res[0]->meta_value; ?>" class="w-5 mr-2" />
                                            </figure>
                                        </label>
                                        <div class="text-xs"><label for="filter-<?php echo $category->slug; ?>"><?php echo strtoupper($category->name); ?></label></div>
                                    </div>
                                </div>
                        <?php
                            endif;
            ...
            <div class="category-filter w-56 lg:w-60 xl:w-52 flex items-center lg:ml-5 mb-5 lg:mb-0 relative filter-tags" data-container=".upcoming-post-wrapper" data-event="upcoming">
                <div class="font-medium relative">
                    <div class="filter-header cursor-pointer flex flex-row border-swissred border py-1 px-2 h-8">
                        <div class="flex self-center flex-col">
        ...
        ?>
            ...
            <?php if ($upcoming_posts->found_posts > get_option('posts_per_page')) : ?>
    ...
    <div class="w-11/12 lg:w-10/12 mx-auto my-16" id="past-events">
        <div class="title flex mb-6 flex-col lg:flex-row">
            ...
            <div class="category-filter w-56 lg:w-60 xl:w-52 flex items-center lg:ml-20 my-5 lg:my-0 filter-category" data-container=".past-post-wrapper" data-event="past">
                <div class="font-medium relative">
                    <div class="filter-header cursor-pointer flex flex-row border-swissred border py-1 px-2 h-8">
                        <div class="flex self-center flex-col">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/backpages/icon-catagories-2x.png" class="w-5 mr-2" />
            ...
            <div class="category-filter w-56 lg:w-60 xl:w-52 flex items-center lg:ml-5 mb-5 lg:mb-0 relative filter-tags" data-container=".past-post-wrapper" data-event="past">
                <div class="font-medium relative">
                    <div class="filter-header cursor-pointer flex flex-row border-swissred border py-1 px-2 h-8">
                        <div class="flex self-center flex-col">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/backpages/icon-location-2x.png" class="w-5 mr-2" />
