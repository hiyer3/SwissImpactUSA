<div class="w-11/12 lg:w-10/12 mx-auto pb-16">
    <div class="title flex mb-6">
        <?php if (is_page()) : ?><h1 class="inline-block">Latest posts</h1><?php endif; ?>
    ...
    if ($primary_category) {
        $args['meta_query'] = array(
            array(
                ...
                'value' => get_category_by_slug($primary_category)->term_id,
            )
        );
    } else if($term_list) {
