...
class ProDropdownMapEntries {
    ...
    public function init() {
        add_shortcode( 'display-map-dropdown', [ $this, 'render_map_dropdown' ] );
    }
            ...
            foreach ( $all_maps as $key => $map ) {
                foreach ( $series as $serie ) {
                    ...
                    if ( $serie === 'regions' ) {
                        ...
                        $label_property = isset( $map['externalDropdown']['nameProperty'] ) && $map['externalDropdown']['nameProperty'] !== '' ? $map['externalDropdown']['nameProperty'] : 'name';
                    ...
                    // everything else id=id
                        ...
                        $label_property = isset( $map['externalDropdown']['nameProperty'] ) && $map['externalDropdown']['nameProperty'] !== '' ? $map['externalDropdown']['nameProperty'] : 'id';
                        foreach ( $map[ $serie ] as $entry ) {
                            $all_entries[ $entry['id'] ] = $this->pro_actions->getArrayValueByDotNotation( $entry, $label_property );
                        }
                    }
                ...
                if ( is_array( $optgroup ) ) {
                    $map['title']              = isset( $map['title'] ) ? $map['title'] : get_the_title( $map['id'] );
