...
class ProSettings {
    ...
    public function __construct( Core $core ) {
        ...
        add_filter( 'igm_model', [ $this, 'add_pro_settings' ] );
        add_action( 'csf_interactive-maps_saved', [ $this, 'flush_rewrite_map' ] );
    }
    ...
    public function add_pro_settings( $settings ) {
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['public'] = [
            ...
            'fields'     => [
                ...
                'image_info' => [
                    'type'    => 'content',
                    'content' => __( 'When viewing the single page for the map, you can add the parameter <em>?image</em> to the URL to get the map as an image.', 'interactive-geo-maps' ),
                ]
            ],
        ];
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['regionFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Regions Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Regions tab', 'interactive-geo-maps' ),
            'fields'     => [
                'otherSources' => [
                    'type'       => 'switcher',
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['markerFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Marker Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Round Markers tab', 'interactive-geo-maps' ),
            'fields'     => [
                'otherSources'       => [
                    'type'       => 'switcher',
                    'title'      => __( 'Other Data Sources', 'interactive-geo-maps' ),
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['imageMarkerFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Image Marker Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Image Markers tab.', 'interactive-geo-maps' ),
            'fields'     => [
                'enabled' => [
                    'type'       => 'switcher',
                    'title'      => __( 'Enabled', 'interactive-geo-maps' ),
                    'subtitle'   => __( 'Disable if you prefer to remove the Image Markers tab altogether.', 'interactive-geo-maps' ),
                    'default'    => true,
                ]
            ]
        ];
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['iconMarkerFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Icon Marker Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Icon Markers tab.', 'interactive-geo-maps' ),
            'fields'     => [
                'enabled' => [
                    'type'       => 'switcher',
                    'title'      => __( 'Enabled', 'interactive-geo-maps' ),
                    'subtitle'   => __( 'Disable if you prefer to remove the Icon Markers tab altogether.', 'interactive-geo-maps' ),
                    'default'    => true,
                ]
            ]
        ];
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['labelFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Label Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Labels tab.', 'interactive-geo-maps' ),
            'fields'     => [
                'enabled' => [
                    'type'       => 'switcher',
                    'title'      => __( 'Enabled', 'interactive-geo-maps' ),
                    'subtitle'   => __( 'Disable if you prefer to remove the Labels tab altogether.', 'interactive-geo-maps' ),
                    'default'    => true,
                ]
            ]
        ];
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['lineFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Line Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Lines tab.', 'interactive-geo-maps' ),
            'fields'     => [
                'enabled' => [
                    'type'       => 'switcher',
                    'title'      => __( 'Enabled', 'interactive-geo-maps' ),
                    'subtitle'   => __( 'Disable if you prefer to remove the Lines tab altogether.', 'interactive-geo-maps' ),
                    'default'    => true,
                ]
            ]
        ];
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['legendFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Legend Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Legend tab.', 'interactive-geo-maps' ),
            'fields'     => [
                'enabled' => [
                    'type'       => 'switcher',
                    'title'      => __( 'Enabled', 'interactive-geo-maps' ),
                    'subtitle'   => __( 'Disable if you prefer to remove the Legend tab altogether.', 'interactive-geo-maps' ),
                    'default'    => true,
                ]
            ]
        ];
        ...
        $settings['settings']['interactive-maps']['sections']['mapFeatures']['fields']['overlayFeatures'] = [
            'type'       => 'fieldset',
            'title'      => __( 'Overlay Features', 'interactive-geo-maps' ),
            'subtitle'   => __( 'Disable features from the Overlay tab.', 'interactive-geo-maps' ),
            'fields'     => [
                'enabled' => [
                    'type'       => 'switcher',
                    'title'      => __( 'Enabled', 'interactive-geo-maps' ),
                    'subtitle'   => __( 'Disable if you prefer to remove the Overlay tab altogether.', 'interactive-geo-maps' ),
                    'default'    => true,
                ]
            ]
        ];
        ...
        $map_field = [
            'map_field' => [
                'type'    => 'switcher',
                'title'   => __( 'Use OpenStreetMap', 'interactive-geo-maps' ),
        ...
        $settings['settings']['interactive-maps']['sections']['lightbox'] = [
            ...
            'fields' => [
                ...
                'lightbox_height'      => [
                    'type'       => 'spinner',
                    'title'      => __( 'Lightbox Height', 'interactive-geo-maps' ),
                    'desc'       => __( 'Height in pixels of the lightbox height in the click actions.', 'interactive-geo-maps' ),
                    'default'    => 500,
                    'min'        => 20,
                    'max'        => 2800,
                    'step'       => 20,
        ...
        $settings['settings']['interactive-maps']['sections']['visual'] = [
            ...
            'fields' => [
                ...
                'rightContent'           => [
                    'type'   => 'fieldset',
                    'title'  => __( 'Content on the right', 'interactive-geo-maps' ),
                    'fields' => [
                        'backgroundColor' => [
                            'type'    => 'color',
                            'default' => 'transparent',
                            'title'   => __( 'Background', 'interactive-geo-maps' ),
                ...
                'contentFilters'         => [
                    'type'   => 'fieldset',
                    'title'  => __( 'Action Content Filters', 'interactive-geo-maps' ),
                    'fields' => [
                        'wpautop' => [
                            'type'    => 'switcher',
                            'title'   => __( 'Automatically add paragraphs', 'interactive-geo-maps' ),
                            'desc'    => __( 'When enabled, the <a target="_blank" href="https://developer.wordpress.org/reference/functions/wpautop/">wpautop()</a> function will run in the content and automatically replace line breaks with paragraphs.', 'interactive-geo-maps' ),
                            'default' => true,
                        ],
                    ],
        ...
        $settings['settings']['interactive-maps']['sections']['amcharts'] = [
            ...
            'fields' => [
                ...
                // doesn't work as expected. Only translates the entries without data.
                /*
                'amcharts_lang'  => [
                    'type'    => 'text',
                    'title'   => __( 'Lang', 'interactive-geo-maps' ),
                    'desc'    => __( 'Loads a translation file for the countries. <a target="_blank" href="https://www.amcharts.com/docs/v4/tutorials/using-map-country-name-translations/">Check available codes</a>. Example <code>ES</code><br> This will only work for country codes.', 'interactive-geo-maps' ),
                    'default' => '',
                ],
                */
