...
class ProMeta {
    ...
    public function __construct() {
        ...
        add_filter( 'igm_model', [ $this, 'meta_options' ], 10, 1 );

        // add extra map options for meta
        add_filter( 'igm_map_options', [ $this, 'map_options' ] );
    }
    ...
    public function meta_options( $model ) {
        ...
        if ( ! isset( $options['regionFeatures'] ) || empty( $options['regionFeatures'] ) || ( isset( $options['regionFeatures'] ) && isset( $options['regionFeatures']['otherSources'] ) && $options['regionFeatures']['otherSources'] ) ) {
            $model['meta']['map_info']['sections']['regions']['fields']['regionsDataSource'] = [
                ...
                'class'    => 'mapinfo__input--wide regionsDataSource',
                'fields'   => [
                    'enabled'                               => [
                        'type'    => 'switcher',
                        'default' => false,
                    ...
                    'google_api_key'                        => [
                        ...
                        'default'    => '',
                        'desc'       => __( 'The API Key should have the Spreadsheet service enabled.', 'interactive-geo-maps' ) . '<br><a href="https://interactivegeomaps.com/docs/pro-populate-map-with-data-from-google-spreadsheet/" target="_blank">' . __( 'More Information', 'interactive-geo-maps' ) . '</a> <span class="dashicons dashicons-external"></span>',
                    ...
                    'json'                                  => [
                        ...
                        'default'    => '',
                        'desc'       => __( 'The data should be an array of objects. Example:', 'interactive-geo-maps' ) . '<br>' . $formatted_json . '<br>' . __( 'You can also use a URL to a JSON file, instead of the JSON code. URL content will be cached for some time.', 'interactive-geo-maps' ),
                    ...
                    'json_id'                               => [
                        ...
                        'default'    => 'id',
                        'desc'       => __( 'If your data entries do not contain an <code>id</code> property, specify which property to use instead. You can use dot notation.', 'interactive-geo-maps' ),
                        'dependency' => [ [ 'enabled', '==', true ], [ 'type', '==', 'json_data' ] ],
                    ],
                    'json_data_source'                      => [
                        'type'       => 'text',
                    ...
                    'action_content_template'               => [
                        ...
                        'default'    => '{content}',
                        'desc'       => __( 'You can setup a custom template for the action content with <strong>placeholders</strong> (using brackets) for parameters that exist in your content object.<br>Leave blank or the default <code>{content}</code> if you prefer to use the default or defined above value.', 'interactive-geo-maps' ),
                        'dependency' => [ [ 'enabled', '==', true ], [ 'type', 'any', 'google_spreadsheet,json_data,cpt_acf' ] ],
                    ],
                ],
            ];
        }

        $model['meta']['map_info']['sections']['regions']['fields']['combineRegions'] = [
            'type'     => 'fieldset',
            /* translators: legend refers to a caption or visual element explaining colours on map */
            'title'    => __( 'Combine entries', 'interactive-geo-maps' ),
            'subtitle' => __( 'If there are entries with the same region ID, the content will be combined.', 'interactive-geo-maps' ),
            'fields'   => [
                'enabled'    => [
                    'type'    => 'switcher',
                    'title'   => __( 'Enabled', 'interactive-geo-maps' ),
                ...
                'mergeOrder' => [
                    'type'       => 'sortable',
                    'title'      => 'Merge order of Regions',
                    'help'       => 'Drag & Drop the items',
                    'subtitle'   => 'Will merge the content in the following order.',
                    'class'      => 'mergeOrderFields',
                    'dependency' => [ 'enabled', '==', true ],
                    'fields'     => [
                        [
                            'id'      => 'manual_entry',
        ...
        $model['meta']['map_info']['sections']['regions']['fields']['regionLegend'] = [
            ...
            'fields'   => [
                'enabled' => [
                    ...
                    'default' => false,
                    'options' => [
                        false          => __( 'No', 'interactive-geo-maps' ),
                        true           => __( 'Yes', 'interactive-geo-maps' ),
                        'onlyGroups'   => __( 'Yes - Only Grouped Regions', 'interactive-geo-maps' ),
                        'ignoreGroups' => __( 'Yes - Ignore Grouped Regions', 'interactive-geo-maps' ),
                    ],
                ],
                'title'   => [
                    'type'       => 'text',
        ...
        if ( ! isset( $options['regionFeatures'] ) || empty( $options['regionFeatures'] ) || ( isset( $options['regionFeatures'] ) && isset( $options['regionFeatures']['autoLabels'] ) && $options['regionFeatures']['autoLabels'] ) ) {
            $model['meta']['map_info']['sections']['regions']['fields']['regionLabels'] = [
                ...
                'desc'     => __( 'Automatically add labels to the regions. <br> This will calculate the visual center of each region and add a label to it, based on the available data. It might fail or have a wrong position on some cases. You can drag & drop them into a new position.', 'interactive-geo-maps' ),
                'fields'   => [
                    'source'                             => [
                        'type'    => 'select',
                        'title'   => __( 'Automatic Labels', 'interactive-geo-maps' ),
                    ...
                    'regionLabelCustomCoordinatesReset'  => [
                        'type'       => 'content',
                        'dependency' => [ 'source', '!=', '0' ],
                        'content'    => '<a class="button" id="igm-reset-auto-labels">' . __( 'Reset labels position', 'interactive-geo-maps' ) . '</a>',
                    ],
        ...
        $model['meta']['map_info']['sections']['roundMarkers']['fields']['roundMarkers']['fields']['id']['desc'] = __( 'Use unique titles, if possible without special characters.', 'interactive-geo-maps' );
        ...
        if ( ! isset( $options['markerFeatures'] ) || empty( $options['markerFeatures'] ) || ( isset( $options['markerFeatures'] ) && isset( $options['markerFeatures']['otherSources'] ) && $options['markerFeatures']['otherSources'] ) ) {
            $model['meta']['map_info']['sections']['roundMarkers']['fields']['markersDataSource'] = [
                ...
                'sanitize' => __NAMESPACE__ . '\ProMeta::legacy_raw_sanitize',
                'class'    => 'mapinfo__input--wide markersDataSource',
                'fields'   => [
                    'enabled'                                 => [
                        'type'    => 'switcher',
                        'default' => false,
                    ...
                    'json_id'                                 => [
                        ...
                        'title'      => __( 'JSON ID property', 'interactive-geo-maps' ),
                        'default'    => 'id',
                        'desc'       => __( 'If your data entries do not contain an <code>id</code> property, specify which property to use instead.', 'interactive-geo-maps' ),
                        'dependency' => [ [ 'enabled', '==', true ], [ 'type', '==', 'json_data' ] ],
                    ],
                    'json_lat'                                => [
                        'type'       => 'text',
                        ...
                        'default'    => 'latitude',
                        'desc'       => __( 'If your data entries do not contain a <code>latitude</code> property, specify which property to use instead.', 'interactive-geo-maps' ),
                        'dependency' => [ [ 'enabled', '==', true ], [ 'type', '==', 'json_data' ] ],
                    ],
                    'json_lon'                                => [
                        'type'       => 'text',
                        ...
                        'default'    => 'longitude',
                        'desc'       => __( 'If your data entries do not contain a <code>longitude</code> property, specify which property to use instead.', 'interactive-geo-maps' ),
                        'dependency' => [ [ 'enabled', '==', true ], [ 'type', '==', 'json_data' ] ],
                    ],
                    'json_action_content'                     => [
                        'type'       => 'text',
                        'title'      => __( 'JSON Action Content property', 'interactive-geo-maps' ),
                        'default'    => '',
                        'desc'       => __( 'If your data entries do not contain a <code>content</code> property, specify which property to use instead. This is the property that will contain the content that is triggered when the marker is clicked.', 'interactive-geo-maps' ),
                        'dependency' => [ [ 'enabled', '==', true ], [ 'type', '==', 'json_data' ] ],
                    ],
                    'action_content_template'                 => [
                        'type'       => $ttemplate_editor,
            ...
            $model['meta']['map_info']['sections']['roundMarkers']['fields']['roundMarkerLabels'] = [
                ...
                'fields'   => [
                    ...
                    'position'   => [
                        ...
                        'desc'       => __( 'Where the labels should be placed', 'interactive-geo-maps' ),
                        'dependency' => [ 'enabled', '==', true ],
                    ],
                    'mobileSize' => [
                        'type'    => 'spinner',
            ...
            $model['meta']['map_info']['sections']['roundMarkers']['fields']['clusterMarkers'] = [
                ...
                'fields'   => [
                    'enabled'         => [
                        ...
                        'default' => false,
                        'title'   => __( 'Enabled', 'interactive-geo-maps' ),
                        'desc'    => __( 'Zoom controls should be enabled for this to work correctly. <br>Might not work well in combination with other advanced features.', 'interactive-geo-maps' ),
                    ],
                    'zoomLevel'       => [
                        'type'       => 'spinner',
            ...
            $model['meta']['map_info']['sections']['imageMarkers'] = [
                ...
                'fields' => [
                    ...
                    'imageMarkersDataSource'      => [
                        ...
                        'title'    => __( 'Other Data Sources', 'interactive-geo-maps' ),
                        'subtitle' => __( 'Use other data sources to populate the markers.', 'interactive-geo-maps' ),
                        'class'    => 'mapinfo__input--wide imageMarkersDataSource',
                        'fields'   => [
                            'enabled'             => [
                                'type'    => 'switcher',
                                'default' => false,
                            ...
                            'json_image'          => [
                                ...
                                'default'    => '',
                                'desc'       => __( 'If your data entries do not contain a <code>href</code> property, specify which property to use instead to grab the image URL. If empty, the default image will be used.', 'interactive-geo-maps' ),
                                'dependency' => [ [ 'enabled', '==', true ], [ 'type', '==', 'json_data' ] ],
                            ],
                            'json_action_content' => [
                                'type'       => 'text',
            ...
            $model['meta']['map_info']['sections']['iconMarkers'] = [
                ...
                'fields' => [
                    ...
                    'iconMarkersDataSource'      => [
                        ...
                        'title'    => __( 'Other Data Sources', 'interactive-geo-maps' ),
                        'subtitle' => __( 'Use other data sources to populate the markers.', 'interactive-geo-maps' ),
                        'class'    => 'mapinfo__input--wide iconMarkersDataSource',
                        'fields'   => [
                            'enabled'                                 => [
                                'type'    => 'switcher',
                                'default' => false,
        ...
        if ( ! isset( $options['labelFeatures'] ) || empty( $options['labelFeatures'] ) || ( isset( $options['labelFeatures'] ) && isset( $options['labelFeatures']['enabled'] ) && $options['labelFeatures']['enabled'] ) ) {
            $model['meta']['map_info']['sections']['labels'] = [
                ...
                'fields' => [
                    ...
                    // current approach on maps service not working
                    'labelsMobileSize'      => [
                        'type'    => 'spinner',
                        'title'   => __( 'Mobile Size', 'interactive-geo-maps' ),
                        'default' => 100,
        ...
        if ( ! isset( $options['lineFeatures'] ) || empty( $options['lineFeatures'] ) || ( isset( $options['lineFeatures'] ) && isset( $options['lineFeatures']['enabled'] ) && $options['lineFeatures']['enabled'] ) ) {
            ...
            // run only on map edit screen
            if ( is_admin() && isset( $_GET['post'] ) ) {
                global $typenow;
                // seems it's not always available..
                if ( empty( $typenow ) ) {
                    // try to pick it up from the query string
                    $post    = get_post( sanitize_key( $_GET['post'] ) );
                    $typenow = $post ? $post->post_type : '';
                }
                ...
                if ( $typenow === 'igmap' ) {
                    ...
                    $map_meta = get_post_meta( sanitize_key( $_GET['post'] ), 'map_info', true );

                    if ( ! empty( $map_meta ) ) {
                        foreach ( $series as $serie ) {
                            if ( ! empty( $map_meta[$serie] ) && is_array( $map_meta[$serie] ) ) {
                                foreach ( $map_meta[$serie] as $key => $value ) {
                                    $existing_markers[ $serie . $value['id'] ] = $serie . ': ' . $value['id'];
                                }
                            }
                        }
                    }
                        ...
                        'fields'       => [
                            ...
                            'multiGeoLine' => [
                                ...
                                'fields'       => [
                                    'pointCoordinates' => [
                                        'type'    => 'select',
                                        'title'   => __( 'Coordinates type', 'interactive-geo-maps' ),
                                        'desc'    => __( 'Select existing marker or add custom coordinates. Save your map to update existing marker options. If you change the title of a marker, you will need to select it again here.', 'interactive-geo-maps' ),
                                        'options' => array_merge( [
                                            'custom' => __( 'Custom coordinates', 'interactive-geo-maps' ),
                                        ], $existing_markers ),
                                        'default' => 'custom',
                                    ],
                                    'coordinates'      => [
                                        'type'       => $coordinates_editor,
                                        'title'      => __( 'Point Coordinates', 'interactive-geo-maps' ),
                                        'dependency' => [ 'pointCoordinates', '==', 'custom' ],
                                        'fields'     => [
                                            'name'      => [
                                                'type'       => 'text',
                                                'title'      => __( 'Title', 'interactive-geo-maps' ),
                            ...
                            'arrow'        => [
                                'type'       => 'switcher',
                                'title'      => __( 'Arrow (Beta)', 'interactive-geo-maps' ),
                                'desc'       => __( 'Will add an arrow to the end of the line. Experimental Feature.', 'interactive-geo-maps' ),
                                'default'    => false,
                                'dependency' => [ 'useDefaults', '==', false ],
                            ],
                        ],
                ...
                'fields' => [
                    ...
                    'liveFilter'       => [
                        ...
                        'fields' => [
                            ...
                            'orderInfo'     => [
                                'type'       => 'submessage',
                                'content'    => __( 'The menu order will be the same as the overlay order above. You can rearrange the order if needed using drag&drop.', 'interactive-geo-maps' ),
                                'dependency' => [ 'enabled', '==', true ],
                                'style'      => 'info',
                            ],
                        ],
                ...
                'tooltip' => [
                    ...
                    'fields' => [
                        ...
                        'showTooltipOn'           => [
                            ...
                            'desc'       => __( 'When the tooltip should display. This is still an experimental feature. It does not work consistently. Make sure to test properly.', 'interactive-geo-maps' ),
                            'dependency' => [[ 'enabled', '==', true ], [ 'fixed', '==', true ]],

                        ],
                        'toolTipPosition'         => [
                            'type'       => 'select',
                            'title'      => __( 'Position of the Tooltip', 'interactive-geo-maps' ),
                            'default'    => 'vertical',
                            'options'    => [
                                'horizontal' => __( 'Horizontal', 'interactive-geo-maps' ),
                                'vertical'   => __( 'Vertical (Default)', 'interactive-geo-maps' ),
                                'below'      => __( 'Below', 'interactive-geo-maps' ),
                                'above'      => __( 'Above', 'interactive-geo-maps' ),
                                'right'      => __( 'On the Right', 'interactive-geo-maps' ),
                                'left'       => __( 'On the Left', 'interactive-geo-maps' ),
                            ],
                            'desc'       => __( 'IMPORTANT: in some situations, like having multiple tooltips stacked for multiple series, the "up" and "down" values might be ignored in order to make tooltip overlap algorithm work.', 'interactive-geo-maps' ),
                            'dependency' => [[ 'enabled', '==', true ], [ 'fixed', '==', true ], [ 'showTooltipOn', '==', 'always' ] ],
                        ...
                        'renderHTML'              => [
                            ...
                            'default'    => false,
                            'options'    => [
                                'asSettings' => __( 'As in MapGeo Global Settings', 'interactive-geo-maps' ),
                                'editor'     => __( 'Render as editor', 'interactive-geo-maps' ),
                                'html'       => __( 'Render as HTML', 'interactive-geo-maps' ),
                            ],
                ...
                'zoom'             => [
                    ...
                    'fields' => [
                        ...
                        'enabled'           => [
                            ...
                            'desc'    => __( 'Allow users to control zoom functions.', 'interactive-geo-maps' ),
                ...
                'fullScreen'       => [
                    ...
                    'fields' => [
                        ...
                        'enabled'         => [
                            'type'    => 'switcher',
                            'title'   => __( 'Enable', 'interactive-geo-maps' ),
                            'desc'    => __( 'Display a button that allows users to set the map to take the fullscreen. <br>Some features might not be available when the map is on fullscreen.<br><b>Consider that some browsers and operating system versions do not support fullscreen mode</b>.', 'interactive-geo-maps' ),
                            'default' => false,
                        ],
                        'mobileOnly'      => [
                            'type'       => 'switcher',
                ...
                'externalDropdown' => [
                    ...
                    'fields' => [
                        ...
                        'enabled'                       => [
                            'type'    => 'switcher',
                            'title'   => __( 'Enable', 'interactive-geo-maps' ),
                            'desc'    => __( 'Display a dropdown outside the map that will allow users to select an entry on the map. Currently not working with overlay maps.<br>To display the dropdown anywhere on your page, you can also use the shortcode: <pre>[display-map-dropdown id="' . ( isset( $_GET['post'] ) ? (int) sanitize_key( $_GET['post'] ) : 'x' ) . '"]</pre> .', 'interactive-geo-maps' ),
                            'default' => false,
                        ],
                        'mobileOnly'                    => [
                            'type'       => 'switcher',
                        ...
                        'nameProperty'                  => [
                            ...
                            'desc'       => __( 'Select object properties to populate the labels and searchable fields for each entry. Useful if you\'re using external data sources. Separate multiple fields with a comma. Otherwise leave empty by default.', 'interactive-geo-maps' ),
                            'default'    => '',
                            'dependency' => [ 'enabled', '==', true ],
                        ],
                        'placeholder'                   => [
        ...
        if ( current_user_can( $capability ) ) {
            // disable sanitize, to allow iframes/scripts on action content for regions
